"""
Currently, the only scrapers in use is AnimixPlay.to + AnimeFillerList.

However, keep in mind that you wouldn't be able to select quality for your anime's episodes. (They will range from 480p to 1080p.)
