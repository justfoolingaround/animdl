...
def get_using_xpath(afl_url, xpath):
    ...
    return [(
            int(tr.xpath('td[@class="Number"]')[0].text),
            tr.xpath('td[@class="Title"]/a')[0].text,
            tr.xpath('td[@class="Type"]/span')[0].text,
            tr.xpath('td[@class="Date"]')[0].text,
            ) for tr in parsed.xpath(xpath)]