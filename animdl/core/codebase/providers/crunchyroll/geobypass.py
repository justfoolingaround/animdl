...
headers = httpx.Headers(
    {
        ...
        b"User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.159 Safari/537.36".encode(
            "ascii"
        ),
    }
)
...
def get_session_id():
    return (
        httpx.get(BYPASS_SERVER, params={"version": "1.1"})
        .json()
        .get("data", {})
        .get("session_id")
    )
